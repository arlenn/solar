...
if(NOT "include;/opt/ros/melodic/include;/usr/include;/opt/ros/melodic/share/xmlrpcpp/cmake/../../../include/xmlrpcpp " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'solar_track' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hardyn/solar/install/${idir}'.  ${_report}")
    endif()
